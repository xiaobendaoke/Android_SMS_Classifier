#!/usr/bin/env python3
"""Run dropout=0.10 with weaker teacher-confidence downweighting."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_teacher_conf_power_0p5_20260806_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["teacher_confidence_power"] = 0.5
    ...
    result = {
        ...
        "hypothesis": (
            "Lowering only teacher_confidence_power increases relative KL weight on low-confidence teacher rows, "
            "testing whether teacher uncertainty helps boundary classes such as HARASS/FRAUD without hard-biasing "
            "the TRANSACTION decision threshold."
        ),
        "only_changed_variable": "distillation.teacher_confidence_power=0.5 (baseline=1.0)",
