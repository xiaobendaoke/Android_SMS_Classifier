...
PROBE="$ROOT/training/data/interim/annotation/probe_minimax_20260807.txt"
OUT="$ROOT/training/data/interim/annotation/probe_minimax_20260807.out"
ERR="$ROOT/training/data/interim/annotation/probe_minimax_20260807.err"
...
lines = [
    "ANNOTATOR_ID: AUTO_MOREAI_MINIMAXM3_PASS_B_001",
...
start=$(date +%s)
timeout --foreground --signal=TERM 300 bash -ic 'opencode run -m moreai/MiniMax-M3 "$(cat /home/colab/projects/Android_SMS_Classifier/training/data/interim/annotation/probe_minimax_20260807.txt)"' >"$OUT" 2>"$ERR"
rc=$?
end=$(date +%s)
