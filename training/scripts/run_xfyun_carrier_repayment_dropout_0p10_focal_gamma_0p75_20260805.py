#!/usr/bin/env python3
"""Run a dropout=0.10 baseline experiment with stronger primary focal weighting."""
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Increasing only the primary focal gamma may focus supervised CE on hard Chinese boundary examples, "
            "testing whether TRANSACTION misses and HARASS/FRAUD confusions can improve without changing split, "
            "labels, teacher logits, or class weights."
        ),
        "only_changed_variable": "distillation.primary_focal_gamma=0.75 (baseline=0.50)",
