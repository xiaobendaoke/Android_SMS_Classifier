#!/usr/bin/env python3
"""Run a distillation variant with a slightly higher teacher confidence floor."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_teacher_conf_floor_0p30_20260806_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["teacher_confidence_floor"] = 0.30
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Lowering the teacher confidence floor slightly from 0.35 to 0.30 may "
            "recover transaction recall and HARASS without losing the precision gain."
        ),
        "only_changed_variable": "distillation.teacher_confidence_floor=0.30 (baseline=0.25)",
