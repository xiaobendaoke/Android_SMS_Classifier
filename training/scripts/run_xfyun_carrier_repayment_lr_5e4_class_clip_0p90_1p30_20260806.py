#!/usr/bin/env python3
"""Run a validation-only narrower class-weight clip on the lr=5e-4 front."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_lr_5e4_class_clip_0p90_1p30_20260806_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Narrowing the balanced class-weight clip on the lr=5e-4 front may "
            "trim extreme minority upweights and recover transaction precision and macro F1."
        ),
        "only_changed_variable": (
            "training.class_weight_clip=[0.90, 1.30] (baseline=[0.75, 1.50]; "
