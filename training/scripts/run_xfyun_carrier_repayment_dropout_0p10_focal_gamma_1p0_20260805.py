#!/usr/bin/env python3
"""Run a dropout=0.10 baseline experiment with primary focal gamma 1.0."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_focal_gamma_1p0_20260805_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Raising only primary focal gamma to 1.0 tests whether the recall gain seen at gamma=0.75 "
            "continues toward the TRANSACTION recall gate or instead degrades precision and minority-class gates."
        ),
        "only_changed_variable": "distillation.primary_focal_gamma=1.0 (baseline=0.50)",
