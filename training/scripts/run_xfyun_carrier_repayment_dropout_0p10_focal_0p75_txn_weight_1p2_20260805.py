#!/usr/bin/env python3
"""Run focal-gamma 0.75 with a lower transaction hard-label multiplier."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_focal_0p75_txn_weight_1p2_20260805_r1"
...
def main() -> int:
    ...
    cfg["training"]["class_weight_multipliers"]["TRANSACTION"] = 1.2
    ...
    result = {
        ...
        "hypothesis": (
            "The gamma=0.75 run improved TRANSACTION recall but over-predicted TRANSACTION. Lowering only the "
            "TRANSACTION hard-label multiplier may recover precision while preserving the focal recall gain."
        ),
        "only_changed_variable": "training.class_weight_multipliers.TRANSACTION=1.2 (baseline=1.4)",
