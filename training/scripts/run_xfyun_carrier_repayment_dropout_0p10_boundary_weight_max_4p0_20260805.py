#!/usr/bin/env python3
"""Run a dropout=0.10 baseline experiment with stronger boundary weighting."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_boundary_weight_max_4p0_20260805_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["boundary_weight_max"] = 4.0
    ...
    result = {
        ...
        "hypothesis": (
            "Increasing only the boundary sample-weight cap may strengthen learning on teacher-identified "
            "transaction and non-transaction boundary cases, aiming to improve TRANSACTION recall and HARASS/FRAUD "
            "separation without changing labels, split, teacher logits, or acceptance thresholds."
        ),
        "only_changed_variable": "distillation.boundary_weight_max=4.0 (baseline=3.0)",
