#!/usr/bin/env python3
"""Run a validation-only HARASS class-weight variant on the lr=5e-4 front."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_lr_5e4_harass_weight_0p9_20260806_r1"
...
def main() -> int:
    ...
    cfg["training"]["class_weight_multipliers"]["HARASS"] = 0.9
    ...
    result = {
        ...
        "hypothesis": (
            "A slightly lower HARASS multiplier on the lr=5e-4 front may reduce "
            "over-penalization and recover HARASS F1 and transaction precision."
        ),
        "only_changed_variable": (
            "training.class_weight_multipliers.HARASS=0.9 (baseline=1.0; "
