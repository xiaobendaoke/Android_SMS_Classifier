...
exec "$ROOT/.venv/bin/python" \
  ...
  --run-id "txn_boundary_r2_arbitration_20260806_r1" \
  --base-data "$ROOT/training/data/processed_transaction_ad_boundary_arbitration_20260806_r1" \
  --selection "zh_transaction_ad_model_boundary_all_no_exclusion"
