#!/usr/bin/env python3
"""Run one ByteCNN capacity variant on the updated provisional overlay."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_conv_filters_128_20260805_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Increasing only ByteCNN convolutional capacity can improve category "
            "separation, especially HARASS and transaction-versus-AD errors."
        ),
        "only_changed_variable": "model.conv_filters=128 (baseline=80)",
