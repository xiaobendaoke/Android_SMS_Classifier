#!/usr/bin/env python3
"""Run a transaction-hard-positive multiplier variant on the updated overlay."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_txn_hard_positive_2p0_20260805_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["transaction_hard_positive_multiplier"] = 2.0
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Increasing only the transaction hard-positive multiplier may push up "
            "transaction recall on difficult positives without the broad collapse "
            "seen when changing the shared protection loss."
        ),
        "only_changed_variable": "distillation.transaction_hard_positive_multiplier=2.0 (baseline=1.5)",
