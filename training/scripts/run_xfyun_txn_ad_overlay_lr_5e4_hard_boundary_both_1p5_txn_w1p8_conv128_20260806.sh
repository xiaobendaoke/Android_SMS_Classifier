...
cp /mnt/c/dev/Android_SMS_Classifier/training/scripts/run_xfyun_txn_ad_overlay_lr_5e4_hard_boundary_both_1p5_txn_w1p8_conv128_20260806.py \
  "$ROOT/training/scripts/run_xfyun_txn_ad_overlay_lr_5e4_hard_boundary_both_1p5_txn_w1p8_conv128_20260806.py"
