#!/usr/bin/env python3
"""Distill a ByteCNN student from the locally trained Chinese teacher."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_student_distill_lr_5e4_20260805_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Reducing only the distillation student's learning rate to 5e-4 "
            "may preserve the teacher signal while stabilizing the final student."
        ),
        "only_changed_variable": "training.learning_rate=5e-4 (baseline=1e-3)",
