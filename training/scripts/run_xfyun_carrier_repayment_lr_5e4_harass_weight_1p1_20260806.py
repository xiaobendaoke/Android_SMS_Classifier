...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_lr_5e4_harass_weight_1p1_20260806_r1"
...
def main() -> int:
    ...
    cfg["training"]["class_weight_multipliers"]["HARASS"] = 1.1
    ...
    result = {
        ...
        "hypothesis": (
            "A small HARASS upweight on the lr=5e-4 front may recover HARASS F1 "
            "without erasing the stability gains from the lower learning rate."
        ),
        "only_changed_variable": (
            "training.class_weight_multipliers.HARASS=1.1 (baseline=1.0; "
