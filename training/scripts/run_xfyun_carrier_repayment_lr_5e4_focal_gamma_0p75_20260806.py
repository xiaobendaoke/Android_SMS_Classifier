#!/usr/bin/env python3
"""Run a validation-only primary focal-gamma variant on the lr=5e-4 front."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_lr_5e4_focal_gamma_0p75_20260806_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Increasing primary focal gamma on the lr=5e-4 front may focus updates "
            "on hard transaction and HARASS boundary examples while retaining optimizer stability."
        ),
        "only_changed_variable": (
            "distillation.primary_focal_gamma=0.75 (baseline=0.50; "
