...
cp /mnt/c/dev/Android_SMS_Classifier/training/scripts/audit_xfyun_carrier_repayment_ad_logit_bias_20260806.py "$ROOT/training/scripts/audit_xfyun_carrier_repayment_ad_logit_bias_20260806.py"
exec "$ROOT/.venv/bin/python" "$ROOT/training/scripts/audit_xfyun_carrier_repayment_ad_logit_bias_20260806.py" --report-root "$REPORT_ROOT" --model "$MODEL_075" --model "$MODEL_100"
