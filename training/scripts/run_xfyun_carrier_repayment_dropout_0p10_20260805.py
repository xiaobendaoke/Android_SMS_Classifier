#!/usr/bin/env python3
"""Run a single-variable dropout validation experiment for the Chinese student."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_20260805_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Reducing only student dropout may preserve more byte-level evidence for transaction templates and "
            "HARASS boundary cases while keeping the existing distillation and class-weight setup unchanged."
        ),
        "only_changed_variable": "model.dropout=0.10 (baseline=0.20)",
