#!/usr/bin/env python3
"""Prepare blind packs for stacked TRANSACTION/AD model-boundary arbitration."""
...
BASE = ROOT / "data" / "processed_harass_fraud_boundary_arbitration_20260806_r1"
PREV_LABELS = [
    ROOT / "data" / "processed_harass_boundary_arbitration_20260806_r1" / "provisional_labels.jsonl",
    BASE / "provisional_labels.jsonl",
]
RUN = "transaction_ad_boundary_arbitration_20260806_r1"
...
MODEL = (
    ...
    / "artifacts"
    / "experiments"
    / "stage2_xfyun_harass_fraud_overlay_lr_5e4_hard_boundary_both_1p5_20260806_r1"
    / "sms_bytecnn_fp32.keras"
)
EXPECTED_SHA = {
    "train": "b2edd2f0dd93869be60ac9ff4df559950a98bf4fae826ca809ecfb8990b22de9",
    "validation": "98f69337917213ee380f06cc694600971287b6ec400f9d1b509ce2b5c8567a43",
}
...
def main() -> int:
    ...
    if not selected:
        raise SystemExit("no new model-boundary candidates after excluding previous rounds")
    ...
    manifest = {
        ...
        "candidate_selection": "zh_transaction_ad_model_boundary_misclassified",
