#!/usr/bin/env python3
"""Run a single-variable dense-width validation experiment for the Chinese student."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dense_units_160_20260805_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Increasing only the post-convolution dense layer width may improve HARASS/AD/FRAUD "
            "class-boundary separation while preserving the existing transaction-focused training setup."
        ),
        "only_changed_variable": "model.dense_units=160 (baseline=96)",
