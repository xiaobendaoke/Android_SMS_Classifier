#!/usr/bin/env python3
"""Run a distillation variant with an intermediate teacher confidence floor."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_teacher_conf_floor_0p32_20260806_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["teacher_confidence_floor"] = 0.32
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Setting the teacher confidence floor between 0.30 and 0.35 may "
            "recover transaction recall while retaining the precision bump."
        ),
        "only_changed_variable": "distillation.teacher_confidence_floor=0.32 (baseline=0.25)",
