#!/usr/bin/env python3
"""Run a distillation variant with a higher teacher confidence floor."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_teacher_conf_floor_0p35_20260805_r1"
...
def main() -> int:
    ...
    cfg["distillation"]["teacher_confidence_floor"] = 0.35
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "Increasing the teacher confidence floor may upweight harder distillation "
            "examples and improve HARASS and transaction recall without changing "
            "the teacher logits or label mix."
        ),
        "only_changed_variable": "distillation.teacher_confidence_floor=0.35 (baseline=0.25)",
