#!/usr/bin/env python3
"""Run dropout=0.10 with a wider byte embedding layer."""
...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_dropout_0p10_embedding_dim_48_20260806_r1"
...
def main() -> int:
    ...
    result = {
        ...
        "hypothesis": (
            "Increasing only the byte embedding dimension may improve Chinese byte-pattern representation "
            "for transaction templates and HARASS boundary phrases without changing convolution filters, "
            "losses, split, labels, or teacher logits."
        ),
        "only_changed_variable": "model.embedding_dim=48 (baseline=32)",
