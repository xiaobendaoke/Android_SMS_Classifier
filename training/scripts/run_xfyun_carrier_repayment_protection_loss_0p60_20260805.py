...
REPO = ROOT.parent
RUN = "stage2_xfyun_carrier_repayment_protection_loss_0p60_20260805_r1"
...
def main() -> int:
    ...
    cfg["transaction_protection"]["loss_weight"] = 0.60
    ...
    result = {
        ...
        "seed": 42,
        "hypothesis": (
            "A slightly lower shared transaction-protection loss weight may keep "
            "the improved transaction recall from 0.70 while recovering precision."
        ),
        "only_changed_variable": "transaction_protection.loss_weight=0.60 (baseline=0.35)",
